...
create table staff(id bigint primary key generated always as identity,name varchar(20),work_id bigint,sex int,birth_date varchar(10),certificate_no varchar(20),edu_level varchar(10),phone varchar(20), address varchar(50),rack_id bigint,lamp_no bigint,profession_id bigint, profession varchar(20),department_id bigint,department varchar(20),clazz_id bigint,clazz varchar(20),image blob,charging_lasttime timestamp);
create table info_item(id bigint primary key generated always as identity,name varchar(20),type int,value varchar(20));
create table lamp_unit(rack_id bigint,lamp_no bigint, name varchar(200), state int,charging_counts int, charging_begintime timestamp,charging_lasttime timestamp,manufacturer varchar(20),primary key(rack_id,lamp_no));
...
create table lamp_change_log(id bigint generated always as identity primary key,rack_id bigint,lamp_no bigint,work_id bigint,staff_name varchar(20),change_time timestamp,operation int);
CREATE table charging_log(id BIGINT generated always as identity PRIMARY KEY,work_id BIGINT,NAME VARCHAR(20),rack_id BIGINT,lamp_no BIGINT,profession VARCHAR(20),department VARCHAR(20),clazz_id BIGINT,clazz VARCHAR(20),underground_begintime timestamp,underground_endtime timestamp,old_state int,new_state int, action int,description VARCHAR(200),last_update_time timestamp default CURRENT_TIMESTAMP,clazz_day char(10)); 
